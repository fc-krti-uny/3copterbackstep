...
void mapremote()
{
  elrsupdate();
  roll_input = 0;
  if (roll_channel > 1500){roll_input=roll_channel-1500;}else if(roll_channel < 1499){roll_input=roll_channel-1499;} roll_input =constrain(roll_input,-511,510); roll_input/=18;roll_input1=roll_input;
  pitch_input = 0;
  if (pitch_channel > 1501){pitch_input=pitch_channel-1501;}else if(pitch_channel < 1500){pitch_input=pitch_channel-1500;} pitch_input =constrain(pitch_input,-512,511); pitch_input/=25;pitch_input1=pitch_input*1.3;
  yaw_input = 0;
  if (yaw_channel > 1508){yaw_input=yaw_channel-1508;}else if(yaw_channel < 1507){yaw_input=yaw_channel-1507;} yaw_input =constrain(yaw_input,-510,480); yaw_input/=8;
